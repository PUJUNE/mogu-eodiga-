# build.py — mogupark/ 모듈들을 단일 배포 html로 병합
# 산출물: ../mogupark.html (더블클릭 실행, 외부 의존 없음)
import base64
import re
from pathlib import Path

HERE = Path(__file__).parent
OUT = HERE.parent / "mogupark.html"
...
html, n = re.subn(r"<script>window\.MPK = \{ ASSETS:.*?\};</script>", embed_assets, html, flags=re.S)
if n != 1:
