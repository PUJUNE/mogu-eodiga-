...
var MODE_MOGU = {
  ...
  ui: {
    ...
    icon: '🐱🎲',
    info:
      '부루마블 · 모두의 마블 모티브 3D 보드게임! (48칸 · 명소 39곳)<br>' +
      '주사위를 굴려 <b>성남·수원·원주의 명소</b>와 <b>대부도 나들이 명소</b>를 사들이고 별장→빌딩→호텔을 지어요.<br>' +
  ...
  tiles: [
    ...
    { kind: 'city', city: 'seongnam', name: '가보고싶은집 본점', price: 320 },       // 21
    ...
    { kind: 'city', city: 'suwon',    name: '대부도 펜션',     price: 450 },          // 32
    ...
    { kind: 'city', city: 'suwon',    name: '나우바다 좌대낚시터', price: 650 },      // 45
