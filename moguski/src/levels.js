...
M.TARGETS = [54, 56.5, 57.5, 59, 62, 63.5, 66.5, 67.5, 69.5, 70.5, 75, 76, 76, 77.5, 78.5,
  81.5, 86, 87.5, 87, 93, 91.5, 94.5, 96, 97, 104.5, 110.5, 110, 107, 115, 117,
  119.5, 126, 131, 138.5, 141, 136.5, 142.5, 147.5, 145.5, 161.5, 161.5, 172.5, 172, 163, 163.5,
  195, 195.5, 205, 200.5, 217];
...
M.makeStage = function (no) {
  ...
  // 양력 계수: 큰 힐일수록 살짝 줄여 후반 비행거리 폭주 방지 (CL_CAL은 튜닝 스크립트용 후크)
  const cl = M.CL_CAL ? M.CL_CAL(K) : 0.0122 - K * 0.000035;

  return {
    no, world, theme, K, K1, EASE, vLip, a, L, wind,
