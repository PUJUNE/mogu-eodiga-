...
function updateSky(){
  ...
  const nightLevel=.18,dayMix=M.clamp((daylight-nightLevel)/(1-nightLevel),0,1);
  sun.intensity=M.lerp(.35+nightLevel*1.25,(.35+1.25)*.6,dayMix);
  hemi.intensity=M.lerp(.35+nightLevel*.85,(.35+.85)*.6,dayMix);
