...
assets_js = (
    'window.MOGU = { ASSETS: { mogu: "%s", icon: "%s" } };'
    % (data_uri("assets/mogu.png"), data_uri("assets/mogu-icon.png"))
)
html = re.sub(
    r'<script>window\.MOGU = \{ ASSETS: .*?\};</script>',
...
order = ["rng.js", "audio.js", "difficulty.js", "stagegen.js", "world.js", "player.js", "ui.js", "main.js"]
