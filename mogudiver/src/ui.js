...
M.ui = {
  screens: ['title-screen', 'pause-screen', 'win-screen', 'ending-screen'],
  toastTimer: null,
  ...
  showWin(st) {
    ...
    $('win-stats').innerHTML = `${st.stage.boss.name} 격파! · 점수 ${st.score} · 하역 ${st.delivered}마리` +
      (st.deaths === 0 ? '<br><b style="color:#7de08a">노 기절!</b>' : `<br>기절 ${st.deaths}회`);
